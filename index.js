...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Functions can reach outside of their lexical environment to grab variables and other functions. They can't reach into other functions from the outside to access data. 
...
function summation(someNum){
  ...
  for(let i = start; i<= end; i++){
    // add result of each loop to result
    result += i;
  }
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(animals){
    let displayName = [];
   animals.forEach(animal => displayName.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`));
  return displayName;
}
